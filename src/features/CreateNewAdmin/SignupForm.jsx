  ...
  const fetchCities = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_BASE_URL}governorates/${governorateId}/cities`
      );
    ...
    <>
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          />
          {passShow ? (
            <HiEye style={IconStyle} onClick={toggleShowPass} />
          ) : (
            <HiEyeSlash style={IconStyle} onClick={toggleShowPass} />
          )}
        </FormRow>
        ...
        >
          <Input
            kind="form"
            type={reppassShow ? "text" : "password"}
            id="passwordConfirm"
          ...
          />
          {reppassShow ? (
            <HiEye style={IconStyle} onClick={togglerepShowPass} />
          ) : (
            <HiEyeSlash style={IconStyle} onClick={togglerepShowPass} />
          )}
        </FormRow>
        ...
        <FormRow label="Governorate" error={errors.governorate?.message}>
          ...
          >
            ...
            {governorate?.data?.map((gover) => (
              <option value={gover?._id} key={gover?._id}>
                {gover?.name}
              </option>
            ))}
          </Select>
